...
instance (Address l, Pretty l, Pretty1 (Cell l)) => Pretty2 (Configuration l) where
...
instance (Address l, Pretty l, Pretty1 (Cell l), Pretty t) => Pretty1 (Configuration l t) where
  liftPretty = liftPretty2 pretty prettyList

instance (Address l, Pretty l, Pretty1 (Cell l), Pretty t, Pretty v) => Pretty (Configuration l t v) where
