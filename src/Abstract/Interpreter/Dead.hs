...
evalDead :: forall l v a. (AbstractAddress l (DeadCodeInterpreter l (Term a) v), Ord a, AbstractValue l v Term a, PrimitiveOperations v (DeadCodeInterpreter l (Term a) v)) => Eval (Term a) (DeadCodeResult l (Term a) v)
