...
evalDead :: forall l v a. (MonadAddress l (Eff (DeadCodeInterpreter l (Term a) v)), Ord a, MonadValue l v Term a (Eff (DeadCodeInterpreter l (Term a) v)), MonadPrim v (Eff (DeadCodeInterpreter l (Term a) v))) => Eval (Term a) (DeadCodeResult l (Term a) v)
