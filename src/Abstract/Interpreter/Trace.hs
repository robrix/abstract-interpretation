...
evalTrace :: forall l v a
          .  (MonadAddress l v (Eff (TraceInterpreter l (Term a) v)), MonadValue l v Term a (Eff (TraceInterpreter l (Term a) v)), MonadPrim v (Eff (TraceInterpreter l (Term a) v)))
...
evalReach :: forall l v a
          .  (Ord a, Ord v, Ord l, Ord1 (Cell l), MonadAddress l v (Eff (ReachableStateInterpreter l (Term a) v)), MonadValue l v Term a (Eff (ReachableStateInterpreter l (Term a) v)), MonadPrim v (Eff (ReachableStateInterpreter l (Term a) v)))
